...
LexoraAI is a privacy-focused, local AI chatbot for querying legal documents using Retrieval-Augmented Generation (RAG). Built with open-source tools, it allows users to upload PDFs, authenticate securely, and get summarized insights from models like Llama3 without cloud dependencies.
...
- Responsive UI with navigation, file management, and real-time streaming replies.
...
- Other: Uvicorn server, npm for dependencies.
...
- Manage files/history via UI icons (trash, edit).
